		...
		if (!$b) {
			...
			foreach ($att as $key => $value) {
				...
				if ($value=="Present") {
					...
					$query = "insert into attendance(value, student_id, date) values('present', $key, '$date')";
...
<input type="submit" class="btn btn-primary" value="Take Attendance" name="take_attendance">
</form>
